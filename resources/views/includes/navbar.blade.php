    ...
    <header class="z-50 sticky top-0 bg-neutral-900 text-neutral-200 border-b border-blue-400 shadow-sm shadow-neutral-900">
        <div class="container mx-auto">
            <div class="flex justify-center items-center h-16 px-3">
                ...
                <nav class="hidden lg:flex flex-1 justify-center space-x-4 text-lg font-thin">
                ...
                <nav class="flex flex-1 justify-end lg:order-1 space-x-4 text-lg font-thin">
                    ...
                    <button class="toggle-menu lg:hidden outline-none text-blue-400 hover:animate-pulse hover:text-neutral-200"><i class="fa fa-bars fa-lg"></i></button>
                </nav>
            </div>
        </div>
    </header>
    <!-- RESPONSIVE NAV -->
    <nav class="z-50 mobile-menu hidden lg:hidden sticky top-16 py-3 flex flex-col justify-center items-center space-y-4 bg-neutral-700 text-neutral-200 border-b border-neutral-900 shadow-sm shadow-neutral-900">
        <a class="hover:animate-pulse hover:text-blue-400" href="/#about-me">About Me</a>
        <a class="hover:animate-pulse hover:text-blue-400" href="/#projects">Projects</a>
        <a class="hover:animate-pulse hover:text-blue-400" href="/contact">Contact</a>
    </nav>